...
with con:
    ...
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('1', 'test_device2', '1234567891', 'тестовая лебедка2', '127.0.0.1', '10201', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('2', 'test_device3', '1234567892', 'тестовая лебедка3', '127.0.0.1', '10201', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('2', 'test_device4', '1234567893', 'тестовая лебедка4', '127.0.0.1', '10203', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('2', 'test_device5', '1234567894', 'тестовая лебедка5', '127.0.0.1', '10204', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('3', 'test_device6', '1234567895', 'тестовая лебедка6', '127.0.0.1', '10205', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('3', 'test_device7', '1234567896', 'тестовая лебедка7', '127.0.0.1', '10206', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('3', 'test_device8', '1234567897', 'тестовая лебедка8', '127.0.0.1', '10207', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('4', 'test_device9', '1234567898', 'тестовая лебедка9', '127.0.0.1', '10208', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('4', 'test_device10', '1234567899', 'тестовая лебедка10', '127.0.0.1', '10209', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('4', 'test_device11', '1234567880', 'тестовая лебедка11', '127.0.0.1', '10210', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('5', 'test_device12', '1234567881', 'тестовая лебедка12', '127.0.0.1', '10211', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('5', 'test_device13', '1234567882', 'тестовая лебедка13', '127.0.0.1', '10212', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('5', 'test_device14', '1234567883', 'тестовая лебедка14', '127.0.0.1', '10213', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('6', 'test_device15', '1234567884', 'тестовая лебедка15', '127.0.0.1', '10214', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('6', 'test_device16', '1234567885', 'тестовая лебедка16', '127.0.0.1', '10215', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('6', 'test_device17', '1234567886', 'тестовая лебедка17', '127.0.0.1', '10216', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('7', 'test_device18', '1234567887', 'тестовая лебедка18', '127.0.0.1', '10217', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('7', 'test_device19', '1234567888', 'тестовая лебедка19', '127.0.0.1', '10218', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('7', 'test_device20', '1234567889', 'тестовая лебедка20', '127.0.0.1', '10219', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('7', 'test_device21', '1234567870', 'тестовая лебедка21', '127.0.0.1', '10220', 'true', '10', '16', '1', 'danfoss', '+3')""")
    con.execute("""INSERT INTO DEVICE (folder_id, name_user, IMEI, description, IP, port, modbus_over_tcp, add_pr200, add_tr16, add_inv, type_inv, GMT) 
                VALUES ('7', 'test_device22', '1234567871', 'тестовая лебедка22', '127.0.0.1', '10221', 'true', '10', '16', '1', 'danfoss', '+3')""")
